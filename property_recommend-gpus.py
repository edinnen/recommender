...
# This is too many for the MBP's teensy GPU
# epochs = 10000
epochs = 200
display_step = 10
...
def tower_loss(scope, inputs, y):
    ...
    Args:
      ...
      inputs: 4D tensor of shape [batch_size, users, properties].
      y: Labels. 4D tensor of shape [batch_size, users, properties].
    Returns:
